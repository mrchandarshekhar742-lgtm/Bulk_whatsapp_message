...
const ExcelRow = require('./ExcelRow');
...
ExcelRecord.hasMany(ExcelRow, { foreignKey: 'excel_record_id', as: 'excel_rows' });
ExcelRow.belongsTo(ExcelRecord, { foreignKey: 'excel_record_id' });
...
ExcelRow.hasMany(DeviceLog, { foreignKey: 'excel_row_id', as: 'device_logs' });
DeviceLog.belongsTo(ExcelRow, { foreignKey: 'excel_row_id' });

Campaign.hasMany(DeviceLog, { foreignKey: 'campaign_id', as: 'device_logs' });
DeviceLog.belongsTo(Campaign, { foreignKey: 'campaign_id' });

// Device Campaign associations
