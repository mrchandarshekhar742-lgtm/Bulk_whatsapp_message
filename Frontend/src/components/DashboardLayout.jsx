  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
      ...
      <main className="flex-1 lg:ml-64 transition-all duration-300 w-full">
        ...
        >
          <div className="px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4 ml-2 sm:ml-4">
              <span className="hidden sm:inline-flex text-xs sm:text-sm font-medium text-gray-600 bg-gray-100 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg whitespace-nowrap">
                📅 {today}
              </span>
            </div>
          </div>
